...
- Blazor-приложение не может быть запущено с локального диска как статическое web-приложение. React-приложение может быть запущено с локального диска, но у него не будут работать: маршрутизация (React Router), API‑запросы, динамическая загрузка ресурсов и хеш‑роутинг
