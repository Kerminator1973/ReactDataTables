...
Акцент в названии классов в Tailwind CSS - на удобстве понимания, например, для того, чтобы задать ширину элемента в одну треть ширины родительского компонента следует использовать класс `w-1/3`. Заметим, что этот класс совместим с другими утилитами Tailwind, например: `max-w-`, `min-w-`, `flex`, `grid`.
