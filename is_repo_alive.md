# Насколько живым является репозитарий на GitHub/Продукт
...
Проект [Avalonia](https://github.com/AvaloniaUI/Avalonia/graphs/contributors) - от 20 до 50 commit-ов в месяц, при том, что пик был c 2020 по 2023 год.
