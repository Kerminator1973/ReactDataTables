...
>Возможно, ситуация улучшилась в React 19, в которой мемоизация была встроена "под капотом", что привело к резкому уменьшению количестве re-rendering-ов.
...
Резюмируя: вычислительная эффективность React (до 19-ой версии) низкая.
...
Однако чаще встречается конструкция с использованием логического операбота &&:
