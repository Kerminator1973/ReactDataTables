...
Этот пример демонстрирует превращение разработки с описания желаемого результата, на большое количество низко-уровневого кода для ручного управления DOM-элементами с большим процентом дублирования.
